...
class SppChildren() {
    ...
    companion object{
        ...
        get()= mutableListOf(
                TestDto(0,"У нас было в порядке вещей, если родители переключали телевизор на свой канал, когда я его смотрел", mutableListOf("ДА, переключали", "НЕТ, такого не было"), mutableListOf(-1,1), SppBallType.sft),
                ...
                TestDto(8,"Помню, что я сильно грустил оттого, что мне не разрешали ложиться спать чуть позже, чем это было принято.", mutableListOf("ДА, грустил", "НЕТ, такого не было"), mutableListOf(-1,1), SppBallType.st),
                ...
                TestDto(12,"Я расстраивался, когда не мог доиграть из-за того, что взрослые звали меня к себе.", mutableListOf("ДА, такое случалось", "НЕТ, такого не было"), mutableListOf(-1,1), SppBallType.st),
                ...
                TestDto(14,"Даже если подходило время ложиться спать, мне обычно разрешали досмотреть любимую передачу.", mutableListOf("ДА, разрешали", "НЕТ, не разрешали досмотреть"), mutableListOf(1,-1), SppBallType.st),
                ...
                TestDto(19,"Родители старались делать со мной уроки, когда я уже справлялся сам.", mutableListOf("ДА, делали со мной уроки", "НЕТ, делал сам"), mutableListOf(-1,1), SppBallType.st),
                ...
                TestDto(22,"Мне случалось огорчаться, если родители неожиданно брали меня в гости.", mutableListOf("ДА, огорчался", "НЕТ, такого не было"), mutableListOf(-1,1), SppBallType.st),
                ...
                TestDto(25,"Меня раздражало, если взрослые не информировали меня о своих планах.", mutableListOf("ДА, раздражало", "НЕТ, это не про меня"), mutableListOf(-1,1), SppBallType.st),
            ...
            TestDto(29,"Если у нас с друзьями возникали общие планы, наши родители нередко старались их изменить.", mutableListOf("ДА, старались изменить", "НЕТ, не меняли наши планы"), mutableListOf(-1,1), SppBallType.st),
            ...
            TestDto(31,"У нас было принято, чтобы родители всегда знали мой распорядок дня.", mutableListOf("ДА, знали", "НЕТ, не знали"), mutableListOf(-1,1), SppBallType.smv),
            ...
            TestDto(34,"Во время обеда, если суп был горячим, я мог сначала съесть второе, и родители это не запрещали.", mutableListOf("ДА, мог съесть второе", "НЕТ, сначала суп"), mutableListOf(1,-1), SppBallType.st),
            ...
            TestDto(38,"Проверяя домашнее задание, родители всегда обращали внимание на порядок его выполнения: сначала основные предметы, а затем “второстепенные”, и были недовольны, если он нарушался.", mutableListOf("ДА, обращали внимание на порядок", "НЕТ, такого не было"), mutableListOf(-1,1), SppBallType.st),
            ...
            TestDto(43,"Если я не сделал домашнее задание, но успел выполнить его на перемене, родители никогда меня не ругали: “Победителя не судят”.", mutableListOf("ДА, не ругали", "НЕТ, ругали"), mutableListOf(1,-1), SppBallType.st),
