...
enum class AnketaQuestionType (var title: String, var ansList:List<String>){
    ...
    Q8("Ваш ребенок сам затачивает свои карандаши?", listOf("Да", "Не совсем", "Нет")),
    ...
    Q13("Ребенок сам моет свою уличную обувь?", listOf("Да", "Не совсем", "Нет")),
    ...
    Q20("Ваш ребёнок уже не хочет ходить с вами за руку?", listOf("Да", "Не совсем", "Нет")),
    Q21("Редко приходится очень торопиться с вашим ребенком, чтобы не опоздать?", listOf("Да", "Не совсем", "Нет")),
    ...
    Q32("Ребенок самостоятельно принимает ванну/душ?", listOf("Да", "Не совсем", "Нет")),
    Q33("Вы (или другие взрослые вашей семьи) уже не встречаете ребёнка у школы после занятий?", listOf("Да", "Не совсем", "Нет")),
